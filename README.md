...
[全武将CSV](data/derived/officers/officers_1546.csv)を追加しました。全1598名を1行ずつ収録し、基本情報・生没年・1546年の所属と配置・5能力と評価理由・親族・出典等を150列に展開しています。Excelでの文字化けを避けるためUTF-8 BOM付きです。

武将辞典に織田信長・豊臣秀吉・徳川家康・上杉謙信・武田信玄・毛利元就・長宗我部元親・島津義弘・北条氏康・今川義元の肖像アイコンを追加しました。スタート画面とゲーム内メニューの「辞典」から、一覧アイコンと詳細肖像を確認できます。[最新版Windows](builds/windows-latest/MyWorldsOnFreedom.exe)。
